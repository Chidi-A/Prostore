...
import { useForm, Resolver, ControllerRenderProps } from 'react-hook-form';
    ...
    <Form {...form}>
      ...
      >
        ...
        <div className="upload-field">
          ...
          Featured Product
          <Card>
            <CardContent className="space-y-2 mt-2 pt-2">
              <FormField
                control={form.control}
                name="isFeatured"
                render={({ field }) => (
                  <FormItem className="space-x-2 flex flex-row items-center">
